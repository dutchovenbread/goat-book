...
class SharingTest(FunctionalTest):
  def test_can_share_a_list_with_another_user(self):
    ...
    share_box = list_page.get_share_box()
     # The share box has a placeholder prompting for an email address
    self.assertEqual(
    ...
    # He sees that Edith's list is there!
    self.browser.find_element(By.LINK_TEXT, "Get help").click()

    # On the list page, Onesiphorus can see that it's Edith's list
    self.wait_for(
    ...
    # When Edith refreshes her browser, she sees Onesiphorus's addition
    self.browser = edith_browser
